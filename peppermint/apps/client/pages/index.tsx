...
export default function Home() {
  ...
  const stats = [
    { name: "Tickets Abertos", stat: openTickets, href: "/issues" },
    {
      name: "Tickets Concluídos",
      stat: completedTickets,
      href: "/issues?filter=closed",
    },
    {
      name: "Tickets Não Atribuídos",
      stat: unassigned,
          ...
          <>
            ...
            <div className="flex w-full flex-col mt-4 px-1 mb-4">
              {tickets !== undefined && tickets.length === 0 ? (
                ...
                <>
                  <span className="font-bold text-2xl">Tickets Recentes</span>
